...
request.onupgradeneeded = function(event) {
    ...
    //create an objkect store (table) called `new_pizza`, set it to have an auto increment primary key of sorts
...
//this is a transaction, or a temporary connection to the database
...
function uploadPizza() {
    ...
    getAll.onsuccess = function() {
        ...
        if (getAll.result.length > 0) {
          fetch('/api/pizzas', {
            method: 'POST',
            // .result is an array of all the data we retrieved from the new_pizza object store
